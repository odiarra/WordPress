...
class MWDViewUninstall_mwd{
	...
	public function mwd_uninstall() {
		...
		<div class="wrap">
			...
			<p><strong><a class="mwd_deactivate_link" href="<?php echo $deactivate_url; ?>" data-uninstall="1">Click Here</a> To Finish the Uninstallation and MailChimp WD will be Deactivated Automatically.</strong></p>
			<input id="task" name="task" type="hidden" value="" />
		</div>
		<?php
	}
