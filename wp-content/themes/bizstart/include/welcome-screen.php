...
class bizstart_screen {
	...
	public function bizstart_admin_notice() {
		...
		<div class="updated notice is-dismissible construction-zone-notice">
			...
			<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=Bizstart_zone_upgrade' ) ); ?>" class="button button-blue-secondary button_info" style="text-decoration: none;"><?php echo esc_html__('Get started with Bizstart','bizstart'); ?></a></p>
		</div>
		<?php
	}
