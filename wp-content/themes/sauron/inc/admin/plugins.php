...
function wdwt_register_required_plugins() {
	...
	$config = array(
		...
		/*
		'strings'      => array(
			'page_title'                      => __( 'Install Required Plugins', "sauron" ),
			'menu_title'                      => __( 'Install Plugins', "sauron" ),
			/* translators: %s: plugin name. * /
			'installing'                      => __( 'Installing Plugin: %s', "sauron" ),
			/* translators: %s: plugin name. * /
			'updating'                        => __( 'Updating Plugin: %s', "sauron" ),
			'oops'                            => __( 'Something went wrong with the plugin API.', "sauron" ),
			...
			'return'                          => __( 'Return to Required Plugins Installer', "sauron" ),
			'plugin_activated'                => __( 'Plugin activated successfully.', "sauron" ),
			'activated_successfully'          => __( 'The following plugin was activated successfully:', "sauron" ),
			/* translators: 1: plugin name. * /
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', "sauron" ),
			/* translators: 1: plugin name. * /
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', "sauron" ),
			/* translators: 1: dashboard link. * /
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', "sauron" ),
			'dismiss'                         => __( 'Dismiss this notice', "sauron" ),
			'notice_cannot_install_activate'  => __( 'There are one or more required or recommended plugins to install, update or activate.', "sauron" ),
			'contact_admin'                   => __( 'Please contact the administrator of this site for help.', "sauron" ),
