 ...
 */
Class Texton_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
 ...
 */
Class Texton_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Texton_Dropdown_Chosen_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="texton-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 * @access public
 */
class Texton_Customize_Section_Upsell extends WP_Customize_Section {
