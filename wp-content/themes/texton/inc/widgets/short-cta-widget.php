...
if ( ! class_exists( 'Texton_Short_Cta_Widget' ) ) :

     
    class Texton_Short_Cta_Widget extends WP_Widget {
        /**
        ...
        public function __construct() {
            $st_widget_cta = array(
                ...
                'description' => esc_html__( 'Compatible Area: Homepage, About Page, Service Page, Sidebar', 'texton' ),
            );
            parent::__construct( 'texton_short_cta_widget', esc_html__( 'ST: Short Call to Action Widget', 'texton' ), $st_widget_cta );
        }
        ...
        public function form( $instance ) {
            $title       = isset( $instance['title'] ) ? ( $instance['title'] ) : esc_html__( 'Short Call to Action', 'texton' );
            $page_id        = isset( $instance['page_id'] ) ? $instance['page_id'] : '';
            $read_more  = isset( $instance['read_more'] ) ? $instance['read_more'] : esc_html__( 'Read More', 'texton' );
